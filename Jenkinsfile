pipeline {
    ...
    environment {
        TYK_DASH_URL = credentials('www.tyk-dashboard.com')
        TYK_ORG_ID = credentials('5c6eb08ab666eb0001cb1d11')
        TYK_DASH_SECRET = credentials('1e62eaa588034fd94f4f19a7a18e0da8')
    }
